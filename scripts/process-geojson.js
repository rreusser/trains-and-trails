  ...
  for (const feature of route.features) {
    ...
    if (feature.properties.mode === 'foot') {
      feature.properties.markers = {
        mi: featureCollection([...Array(Math.ceil(feature.properties.length.mi))].map((_, i) => ({
        ...
        km: featureCollection([...Array(Math.ceil(feature.properties.length.km))].map((_, i) => ({
